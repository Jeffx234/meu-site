  ...
  return (
    <div className="p-4 md:w-full border-red-300" >
      <div className="h-full border-2 border-gray-200 border-opacity-60 roundedLg overflow-hidden">
        ...
        <img className="lg:h-48 md:h-36 w-full object-cover object-center" src={src} alt={alt}/>
        
        <div className="p-4">
          <h2 className="trackingWidest text-xs title-font font-bold text-green-400 mb-1 uppercase ">Web development</h2>
          <h1 className="title-font textLg font-medium text-gray-900 mb-3">This is a blog template</h1>
